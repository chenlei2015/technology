 ...
 * @link
 */
class OverseaTrackExportService
{
    /**
     * client
     *
    ...
    public function export($file_type = 'csv')
    {
        ...
        $this->_ci->load->service('oversea/PrTrackListService');
        return $this->_ci->prtracklistservice->quick_export($this->_gids, $this->_profile, $this->_format_type, $this->_data_type, $this->_charset);
    }
