...
class ActivityExportService
{
    ...
    public function export($file_type = 'csv')
    {
        ...
        $this->_ci->load->service('oversea/ActivityListService');
        return $this->_ci->activitylistservice->quick_export($this->_gids, $this->_profile, $this->_format_type, $this->_data_type, $this->_charset);
    }
