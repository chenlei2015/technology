 ...
 * @link
 */
class OverseaSummaryExportService
{
    /**
     * client
     *
    ...
    public function export($file_type = 'csv')
    {
        ...
        $this->_ci->load->service('oversea/PrSummaryListService');
        return $this->_ci->prsummarylistservice->quick_export($this->_gids, $this->_profile, $this->_format_type, $this->_data_type, $this->_charset);
    }
