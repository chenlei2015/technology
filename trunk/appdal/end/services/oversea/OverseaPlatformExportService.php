 ...
 * @category -
 * @author Jason
 * @since 2019-06-03 16：21
 * @link
 */
class OverseaPlatformExportService
{
    /**
     * client
     *
    ...
    public function export($file_type = 'csv')
    {
        ...
        $this->_ci->load->service('oversea/PlatformListService');
        return $this->_ci->platformlistservice->quick_export($this->_gids, $this->_profile, $this->_format_type, $this->_data_type, $this->_charset);
    }
