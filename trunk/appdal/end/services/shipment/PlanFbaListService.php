 ...
 * @link
 */
class PlanFbaListService extends AbstractList implements Rpcable
{
    use Rpc_imples;
    ...
    public function importDependent()
    {
        ...
        $this->_ci->load->model('Fba_shipment_list_model', 'm_shipment_list', false, 'shipment');
...
//            ],
            'title' =>array_column($this->_ci->lang->myline('fba_shipment_plan_list'),'label'),
            'select_cols' => [
