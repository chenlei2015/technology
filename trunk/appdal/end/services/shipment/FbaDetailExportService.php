...
class FbaDetailExportService
{
    ...
    public function export($file_type = 'csv')
    {
        ...
        $this->_ci->load->service('shipment/FbaListService');
        return $this->_ci->fbalistservice->quick_export($this->_gids, $this->_profile, $this->_format_type, $this->_data_type, $this->_charset,$this->_template,$this->_shipment_sn);
    }
