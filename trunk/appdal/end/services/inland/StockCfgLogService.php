...
class StockCfgLogService
{
    ...
    public function __construct()
    {
        ...
        $this->_ci->load->model('Inland_sku_cfg_log_model', 'm_inland_sku_cfg_log', false, 'inland');
    ...
    public function send($params, $context)
    {
        ...
        $row = $this->_ci->m_inland_sku_cfg_log->fetch_table_cols($params);
        return $this->_ci->m_inland_sku_cfg_log->add($row);
    }
    ...
    public function multi_send($params)
    {
        ...
        return $this->_ci->m_inland_sku_cfg_log->madd($params);
    }

    public function get_one_listing_log($gid, $offset = 1, $limit = 20)
    {
        $total = 0;
        $rows = $this->_ci->m_inland_sku_cfg_log->get($gid, $total, $offset, $limit);
