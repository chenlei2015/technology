 ...
 * @link
 */
class InlandStockCfgExportService
{
    /**
     * client
     *
    ...
    public function export($file_type = 'csv')
    {
        ...
        $this->_ci->load->service('inland/StockCfgListService');
        return $this->_ci->stockcfglistservice->quick_export($this->_gids, $this->_profile, $this->_format_type, $this->_data_type, $this->_charset);
    }
