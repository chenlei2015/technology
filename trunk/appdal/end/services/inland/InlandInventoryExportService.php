 ...
 * @link
 */
class InlandInventoryExportService
{
    /**
     * client
     *
    ...
    public function export($file_type = 'csv')
    {
        ...
        $this->_ci->load->service('inland/InventoryListService');
        return $this->_ci->inventorylistservice->quick_export($this->_gids, $this->_profile, $this->_format_type, $this->_data_type, $this->_charset);
    }
