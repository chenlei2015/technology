 ...
 * @category -
 * @author Jason 13292
 * @since 2019-04-20 10:05
 * @link
 */
class InlandSpecialExportService
{
    /**
     * client
     *
    ...
    public function export($file_type = 'csv')
    {
        ...
        $this->_ci->load->service('inland/PrSpecialListService');
        return $this->_ci->prspeciallistservice->quick_export($this->_gids, $this->_profile, $this->_format_type, $this->_data_type, $this->_charset);
    }
