...
class FbaConditionExportService
{
    /**
     * client
     *
    ...
    public function export($file_type = 'csv',$time_type)
    {
        ...
        return $this->_ci->stockconditionservice->quick_export_fba($this->_gids, $this->_profile, $this->_format_type,$time_type,$this->_data_type, $this->_charset);
