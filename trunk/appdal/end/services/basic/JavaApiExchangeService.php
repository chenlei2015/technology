 ...
 * @link
 */
class JavaApiExchangeService implements ApiAdapterable
{
    /**
     * 控制参数
     * @var unknown
    ...
    private function _get_access_token()
    {
        ...
        try {
            $tokens = $curl->http_post(JAVA_SECRET_PATH, [], [], $auth_opts);
            ...
            $this->_ci->rediss->setData($this->_oauth_token_key, $tokens, $token_info['expires_in'] - 120);
    ...
    protected function get_token()
    {
        ...
        $this->_token = $token_arr['access_token'];
        return $this->_token;
    }
