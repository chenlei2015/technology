...
class PlanListExportService
{
    ...
    public function export($file_type = 'csv')
    {
        ...
        $this->_ci->load->service('plan/PlanListService');
        return $this->_ci->planlistservice->quick_export($this->_gids, $this->_profile, $this->_format_type, $this->_data_type, $this->_charset);
    }
