...
class PlanSummaryExportService
{
    /**
     * client
     *
    ...
    public function export($file_type = 'csv')
    {
        ...
        $this->_ci->load->service('plan/PlanSummaryListService');
        return $this->_ci->plansummarylistservice->quick_export($this->_gids, $this->_profile, $this->_format_type, $this->_data_type, $this->_charset);
    }
