 ...
 * @link
 */
class Fba_list_model extends MY_Model implements Rpcable
{
    ...
    {
        $this->database = 'stock';
        $this->table_name = 'yibai_shipment_fba_list';
        $this->primaryKey = 'gid';
        $this->tableId = 152;
        parent::__construct();
    }
...
//    {
//        $sql = "SELECT detail.*,plan.push_status FROM yibai_shipment_fba_list detail LEFT JOIN yibai_shipment_plan_fba_list plan
...
//    {
//        $result = $this->_db->select('shipment_qty')
...
//            ->get()
//            ->result_array();
//        return array_column($result,'shipment_qty');
//    }
    public function check_gid($gid)
    {
        $sql = "SELECT detail.*,plan.push_status FROM yibai_shipment_fba_list detail LEFT JOIN yibai_shipment_plan_fba_list plan
