...
class ShipmentHugeExport extends AbstractHugeExport
{
    ...
    public function __construct()
    {
        ...
        $this->_ci->load->model('Shipment_list_model', 'm_shipment_list', false, 'shipment');
        $this->_db = $this->_ci->m_shipment_list->getDatabase();
    }
    ...
    protected function get_default_template_cols()
    {
        ...
        return $this->_ci->usercfgprofileservice->export_temple('shipment_pr_list');
    }
