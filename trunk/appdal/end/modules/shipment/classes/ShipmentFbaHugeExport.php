...
class ShipmentFbaHugeExport extends AbstractHugeExport
{
    ...
    public function __construct()
    {
        ...
        $this->_db = $this->_ci->m_fba_list->getDatabase();
    }
    ...
    protected function get_default_template_cols()
    {
        if (!empty($this->template)){
            ...
            //选择模板
            if($this->template == 4){
                $this->template = 'fba_shipment_track_list';
                //需要加上发运详情字段
                $add_field  = [
                    '物流单号'  =>
                        [
                ...
                $this->template = 'fba_shipment_detail_list';
            }
