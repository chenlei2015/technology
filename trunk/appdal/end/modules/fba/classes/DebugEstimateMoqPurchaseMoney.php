 ...
 * @throw
 */
class DebugEstimateMoqPurchaseMoney
{
    ...
    public function estimate($version, $sku)
    {
        ...
        $purchase_old_pr_table = 'yibai_old_purchase_pr_quantity'.date('d');
        $purchase_new_pr_table = 'yibai_new_purchase_pr_quantity'.date('d');
