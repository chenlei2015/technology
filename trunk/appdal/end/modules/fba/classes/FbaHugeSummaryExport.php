...
class FbaHugeSummaryExport extends AbstractHugeExport
{
    ...
    public function __construct()
    {
        ...
        $this->_db = $this->_ci->m_fba_summary->getDatabase();
    }
    ...
    {
        $this->_ci->load->classes('fba/classes/SummaryTemplate');
    ...
    public function run()
    {
        try
        {
            ...
            $file_name = 'FBA需求汇总列表_'.date('YmdHi');
