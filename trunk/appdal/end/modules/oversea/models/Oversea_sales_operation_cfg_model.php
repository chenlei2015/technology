 ...
 * @link
 */
class Oversea_sales_operation_cfg_model extends MY_Model implements Rpcable
{
    ...
    {
        $this->database = 'stock';
        $this->table_name = 'yibai_oversea_sales_operation_cfg';
        $this->yibai_oversea_sales_operation_cfg_sku = 'yibai_oversea_sales_operation_cfg_sku';
        $this->primaryKey = 'gid';
        $this->tableId = 162;
        parent::__construct();
    }
    ...
    public function add_cfg($cfg_data,$skus){
        ...
        if (empty($skus)){
            ...
            $insert_skus = $this->_db->insert_batch('yibai_oversea_sales_operation_cfg_sku',$skus);
        }
    ...
    public function update_cfg($cfg_data,$skus){
        ...
        //删除原始skus数据
        $delete_skus = $this->_db->delete("yibai_oversea_sales_operation_cfg_sku",array('cfg_gid'=>$cfg_data['gid']));
    ...
    public function get_disabled_skus($date = ''):array
    {
        ...
        $this->_db->join($this->yibai_oversea_sales_operation_cfg_sku. ' b','a.gid = b.cfg_gid','left');
