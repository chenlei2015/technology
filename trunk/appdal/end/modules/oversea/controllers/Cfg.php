...
class Cfg extends MY_Controller
{
    ...
    public function list()
    {
        try {
            ...
            $result = [];
            if (!file_exists(APPPATH . 'upload/oversea_cfg.php')) { //文件不存在返回空
                $this->data['status']             = 1;
                $this->data['data_list']['value'] = [];
            } else {
                require_once APPPATH . 'upload/oversea_cfg.php';//引入文件
 ...
 */
\$sale_category_cfg = [
        [0,          0.0000001,   {$sale_category_cfg[0][0]},    {$sale_category_cfg[0][1]},   {$sale_category_cfg[0][2]},  {$sale_category_cfg[0][3]},  {$sale_category_cfg[0][4]},  {$sale_category_cfg[0][5]},  {$sale_category_cfg[0][6]}],
        [0.0000001,  0.1,   	  {$sale_category_cfg[1][0]},    {$sale_category_cfg[1][1]},   {$sale_category_cfg[1][2]},  {$sale_category_cfg[0][3]},  {$sale_category_cfg[0][4]},  {$sale_category_cfg[0][5]},  {$sale_category_cfg[0][6]}],
        [0.1,        0.3,         {$sale_category_cfg[2][0]},    {$sale_category_cfg[2][1]},   {$sale_category_cfg[2][2]},  {$sale_category_cfg[0][3]},  {$sale_category_cfg[0][4]},  {$sale_category_cfg[0][5]},  {$sale_category_cfg[0][6]}],
        [0.3,        0.6,         {$sale_category_cfg[3][0]},    {$sale_category_cfg[3][1]},   {$sale_category_cfg[3][2]},  {$sale_category_cfg[0][3]},  {$sale_category_cfg[0][4]},  {$sale_category_cfg[0][5]},  {$sale_category_cfg[0][6]}],
        [0.6,        1,           {$sale_category_cfg[4][0]},    {$sale_category_cfg[4][1]},   {$sale_category_cfg[4][2]},  {$sale_category_cfg[0][3]},  {$sale_category_cfg[0][4]},  {$sale_category_cfg[0][5]},  {$sale_category_cfg[0][6]}],
        [1,          3,           {$sale_category_cfg[5][0]},    {$sale_category_cfg[5][1]},   {$sale_category_cfg[5][2]},  {$sale_category_cfg[0][3]},  {$sale_category_cfg[0][4]},  {$sale_category_cfg[0][5]},  {$sale_category_cfg[0][6]}],
        [3,          5,           {$sale_category_cfg[6][0]},    {$sale_category_cfg[6][1]},   {$sale_category_cfg[6][2]},  {$sale_category_cfg[0][3]},  {$sale_category_cfg[0][4]},  {$sale_category_cfg[0][5]},  {$sale_category_cfg[0][6]}],
        [5,          10,          {$sale_category_cfg[7][0]},    {$sale_category_cfg[7][1]},   {$sale_category_cfg[7][2]},  {$sale_category_cfg[0][3]},  {$sale_category_cfg[0][4]},  {$sale_category_cfg[0][5]},  {$sale_category_cfg[0][6]}],
        [10,         20,          {$sale_category_cfg[8][0]},    {$sale_category_cfg[8][1]},   {$sale_category_cfg[8][2]},  {$sale_category_cfg[0][3]},  {$sale_category_cfg[0][4]},  {$sale_category_cfg[0][5]},  {$sale_category_cfg[0][6]}],
        [20,         'max',       {$sale_category_cfg[9][0]},    {$sale_category_cfg[9][1]},   {$sale_category_cfg[9][2]},  {$sale_category_cfg[0][3]},  {$sale_category_cfg[0][4]},  {$sale_category_cfg[0][5]},  {$sale_category_cfg[0][6]}],
];
            ";
    ...
    {
        try {
            $file_path               = APPPATH . 'upload/oversea_cfg.php';
    ...
    public function get_cfg_data()
    {
        try {
            ...
            if (!file_exists(APPPATH . 'upload/oversea_cfg.php')) { //文件不存在返回空
                $this->data['status']    = 0;
                $this->data['errorMess'] = 'oversea_cfg.php文件不存在';
            } else {
                require_once APPPATH . 'upload/oversea_cfg.php';//引入文件
                $this->data['data_list'] = compact(['sales_amount_cfg', 'exhaust_cfg', 'in_warehouse_age_cfg', 'supply_day_cfg',  'sale_category_cfg']);;
                $this->data['status']    = 1;
            }
            $code = 200;
        } catch (\InvalidArgumentException $e) {
