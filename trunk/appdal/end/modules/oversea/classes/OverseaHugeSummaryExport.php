...
class OverseaHugeSummaryExport extends AbstractHugeExport
{
    ...
    public function __construct()
    {
        ...
        $this->_db = $this->_ci->oversea_summary->getDatabase();
    }
    ...
    {
        $this->_ci->load->classes('oversea/classes/SummaryTemplate');
    ...
    public function run()
    {
        try
        {
            ...
            $file_name = '海外需求汇总列表_'.date('YmdHi');
