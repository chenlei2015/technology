...
class OverseaHugeTrackExport extends AbstractHugeExport
{
    ...
    public function __construct()
    {
        ...
        $this->_db = $this->_ci->oversea_track_list_model->getDatabase();
    }
    ...
    {
        $this->_ci->load->classes('oversea/classes/TrackTemplate');
    ...
    public function run()
    {
        try
        {
            ...
            $file_name = '海外需求跟踪列表_'.date('YmdHi');
