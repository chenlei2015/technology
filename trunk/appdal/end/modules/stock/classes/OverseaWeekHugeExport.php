...
class OverseaWeekHugeExport extends AbstractHugeExport
{
    ...
    {
        $this->_ci->load->classes('stock/classes/OverseaWeekTemplate');
        return $this->_ci->OverseaWeekTemplate->get_default_template_cols();
    }
    ...
    public function run()
    {
        try
        {
            ...
            $file_name = '海外库存状况列表_周_'.date('Y_m_d_H_i_s');
