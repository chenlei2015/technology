...
class FbaWeekHugeExport extends AbstractHugeExport
{
    ...
    {
        $this->_ci->load->classes('stock/classes/FbaWeekTemplate');
        return $this->_ci->FbaWeekTemplate->get_default_template_cols();
    }
    ...
    public function run()
    {
        try
        {
            ...
            $file_name = 'FBA库存状况列表_周_'.date('Y_m_d_H_i_s');
