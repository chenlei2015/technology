...
class FbaMonthHugeExport extends AbstractHugeExport
{
    ...
    {
        $this->_ci->load->classes('stock/classes/FbaMonthTemplate');
        return $this->_ci->FbaMonthTemplate->get_default_template_cols();
    }
    ...
    public function run()
    {
        try
        {
            ...
            $file_name = 'FBA库存状况列表_月_'.date('Y_m_d_H_i_s');
