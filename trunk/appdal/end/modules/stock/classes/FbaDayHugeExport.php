...
class FbaDayHugeExport extends AbstractHugeExport
{
    ...
    {
        $this->_ci->load->classes('stock/classes/FbaDayTemplate');
        return $this->_ci->FbaDayTemplate->get_default_template_cols();
    }
    ...
    public function run()
    {
        try
        {
            ...
            $file_name = 'FBA库存状况列表_日_'.date('Y_m_d_H_i_s');
