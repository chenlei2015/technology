...
class OverseaDayHugeExport extends AbstractHugeExport
{
    ...
    {
        $this->_ci->load->classes('stock/classes/OverseaDayTemplate');
        return $this->_ci->OverseaDayTemplate->get_default_template_cols();
    }
    ...
    public function run()
    {
        try
        {
            ...
            $file_name = '海外库存状况列表_日_'.date('Y_m_d_H_i_s');
