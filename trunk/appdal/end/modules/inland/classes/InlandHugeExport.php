...
class InlandHugeExport extends AbstractHugeExport
{
    private $_db;
    ...
    public function __construct()
    {
        ...
        $this->_db = $this->_ci->m_inland_pr_list->getDatabase();
    }
    ...
    {
        $this->_ci->load->classes('inland/classes/ListTemplate');
    ...
    public function set_translator() : AbstractHugeExport
    {
        ...
        $this->col_map = [
            ...
            'sku_state'             => SKU_STATE,
            'stock_up_type'         => STOCK_UP_TYPE,
            'is_trigger_pr'         => TRIGGER_PR,
            'expired'               => FBA_PR_EXPIRED,
            'approve_state'               => INLAND_APPROVAL_STATE
        ];
        return $this;
    }
