...
class InlandActivityHugeExport extends AbstractHugeExport
{
    private $_db;
    ...
    public function __construct()
    {
        ...
        $this->_db = $this->_ci->m_inland_activity->getDatabase();
    }
    ...
    protected function get_default_template_cols()
    {
        ...
        foreach ($this->_ci->usercfgprofileservice->export_temple('inland_activity') as $title => $cfg)
        {
