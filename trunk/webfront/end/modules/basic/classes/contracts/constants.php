...
//总推送状态
define('PUSH_STATUS_NO',0);
define('PUSH_STATUS_YES',1);
define('PUSH_STATUS',[
    PUSH_STATUS_YES =>  ['name' =>  '成功'],
    PUSH_STATUS_NO =>  ['name'  =>  '失败'],
]);

//总调拨状态
define('ALLOT_STATUS_NO',0);
define('ALLOT_STATUS_YES',1);
define('ALLOT_STATUS',[
    ALLOT_STATUS_YES =>  ['name' =>  '成功'],
    ALLOT_STATUS_NO =>  ['name'  =>  '失败'],
]);
...
define('SELLER_SKU_MODIFY_COLUMN', [
    'bs' => ['name' => '缓冲库存天数'],
]);
...
define('ERP_SKU_MODIFY_COLUMN', [
    'max_sp' => ['name' => '最大备货天数'],
    'max_lt' => ['name' => '最大供货周期'],
    'max_safe_stock' => ['name' => '最大安全库存天数'],
]);
