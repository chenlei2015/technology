...
$config['assets_path'] = 'front/assets/';

// path structure to use for modules relative to web root
$config['assets_module_path'] = 'application/modules/{module}/assets/';
...
$config['assets_absolute_path'] = TRUE;

// used for caching
$config['assets_last_updated'] = '2014/02/20 15:23:00';
...
//$config['assets_output'] = 'whitespace';
