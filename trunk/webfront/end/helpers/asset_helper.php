...
function csv_path($file = NULL, $module = NULL, $absolute = NULL)
{
	$CI = _get_assets();
	return $CI->asset->csv_path($file, $module, $absolute);
}
...
if ( ! function_exists('getViewPath'))
{
    ...
    {
        $CI =& get_instance();
        return $CI->config->item('view_path');
    }
}
...
if ( ! function_exists('getVersion'))
{
	...
	{
		$CI =& get_instance();
		return $CI->config->item('version_code');
	}
}
